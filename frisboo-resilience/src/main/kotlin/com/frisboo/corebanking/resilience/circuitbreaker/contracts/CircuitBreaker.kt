...
public interface CircuitBreaker<out C : Any> :
     ...
     *
     * Returns [CircuitBreakerResult.Success], [CircuitBreakerResult.Failure],
     * or [CircuitBreakerResult.Rejected] — never throws.
     */
    public suspend fun <T> executeSuspend(block: suspend () -> T): CircuitBreakerResult<T>
}
