...
public val accountClosedReasonArb: Arb<String> = Arb.element(
    listOf(
        "Customer Request",
        "Fraudulent Activity",
        "Account Inactivity",
...
public val accountFrozenReasonArb: Arb<String> = Arb.element(
    listOf(
        "Suspicious Activity",
        "Legal Hold",
...
public val accountUnfrozenReasonArb: Arb<String> = Arb.element(
    listOf(
        "Issue Resolved",
        "Customer Request",
...
public val accountDeletedReasonArb: Arb<String> = Arb.element(
    listOf(
        "Customer Request",
        "Duplicate Account",
        "Fraudulent Activity",
...
public val accountOwnerChangeReasonArb: Arb<String> = Arb.element(
    listOf(
        "Customer Request",
        "Account Merger",
        "Regulatory Requirement",
...
public val accountEventArb: Arb<MockAccountEvent<out Any>> = arbitrary {
    ...
    Arb.of(
        listOf(
            MockAccountCreatedEvent(
                ...
                description = "New ${account.accountType} ${account.currency.code} account ${account.accountNumber} created for customer ${customer.customerId}",
                data = MockAccountCreatedPayload(
            ...
            MockAccountUpdatedEvent(
                ...
                data = MockAccountUpdatedPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
                    updatedFields = mapOf(
            ...
            MockAccountDeletedEvent(
                ...
                data = MockAccountDeletedPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
                    deletedAt = updatedAt,
            ...
            MockAccountUnfrozenEvent(
                ...
                data = MockAccountUnfrozenPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
            ...
            MockAccountActivatedEvent(
                ...
                data = MockAccountActivatedPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
            ...
            MockAccountBalanceUpdatedEvent(
                ...
                data = MockAccountBalanceUpdatedPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
                    oldBalance,
                    newBalance,
            ...
            MockAccountOwnerChangedEvent(
                eventId,
                aggregateId = account.accountId,
                description = "Account ${account.accountNumber} owner changed from customer: ${customer.customerId} to new customer: ${newCustomer.customerId}. Reason: $accountOwnerChangeReason",
                data = MockAccountOwnerChangedPayload(
                    accountId = account.accountId,
            ...
            MockAccountOverdraftLimitUpdatedEvent(
                ...
                data = MockAccountOverdraftLimitUpdatedPayload(
                    accountId = account.accountId,
                    customerId = customer.customerId,
                    oldLimit,
                    newLimit,
