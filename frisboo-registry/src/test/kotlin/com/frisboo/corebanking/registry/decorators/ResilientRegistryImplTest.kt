...
//        factory: suspend () -> V,
//    ): RegistryGetOrPutResult<V> = throw RuntimeException("primary down")
//
...
//        value: V,
//        ttl: kotlin.time.Duration?,
//    ): RegistryPutResult = throw RuntimeException("primary down")
//
//    override suspend fun evict(key: K): RegistryEvictResult = throw RuntimeException("primary down")
//
...
//        key: K,
//        ttl: kotlin.time.Duration,
//    ): RegistrySetTtlResult = throw RuntimeException("primary down")
//}
//
...
//                primary.put("k1", "v1")
//
//                registry.setTTL("k1", 30.seconds) shouldBe RegistrySetTtlResult.Applied
//                registry.setTTL("missing", 30.seconds) shouldBe RegistrySetTtlResult.NotFound
//            }
//        }
//
...
//
//                result shouldBe RegistryGetOrPutResult.Created("computed")
...
//                    }
//
//                result shouldBe RegistryGetOrPutResult.Found("existing")
