...
internal class AuditingRegistryImplTest :
    StringSpec(
        {
            RegistryScope(name = "audit-test", team = "test-team")
...
//
//                result shouldBe RegistryPutResult.Created
...
//
//                result shouldBe RegistryPutResult.Updated
...
//
//                result shouldBe RegistryGetOrPutResult.Created("created-by-getOrPut")
//                captured.size shouldBe 1
//                val event = captured.single()
...
//
//                result shouldBe RegistryGetOrPutResult.Found("value")
//                captured.size shouldBe 0
//            }
//        }
        },
