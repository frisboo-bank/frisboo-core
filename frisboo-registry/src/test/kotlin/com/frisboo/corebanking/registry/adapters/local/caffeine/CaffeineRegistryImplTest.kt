...
//                val registry = CaffeineRegistryImpl<String, String>(scope = scope)
//
//                registry.put("k1", "v1", ttl = null) shouldBe RegistryPutResult.Created
//                registry.put("k1", "v2", ttl = null) shouldBe RegistryPutResult.Updated
//            }
//        }
//
...
//                registry.put("present", "v", ttl = null)
//
//                registry.evict("present") shouldBe RegistryEvictResult.Evicted
...
//
//                registry.setTTL("k1", ttl = 50.milliseconds) shouldBe RegistrySetTtlResult.Applied
//                Thread.sleep(200)
...
//                val registry = CaffeineRegistryImpl<String, String>(scope = scope)
//
//                registry.setTTL("missing", ttl = 50.milliseconds) shouldBe RegistrySetTtlResult.NotFound
//            }
//        }
//
