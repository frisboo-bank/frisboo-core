...
//
//                result.shouldBeInstanceOf<RegistryPutResult.Created>()
...
//
//                result.shouldBeInstanceOf<RegistryPutResult.Updated>()
...
//
//                result.shouldBeInstanceOf<RegistryPutResult.Failed>()
...
//
//                result.shouldBeInstanceOf<RegistryGetOrPutResult.Found<String>>()
...
//
//                result.shouldBeInstanceOf<RegistryGetOrPutResult.Created<String>>()
//                result.value shouldBe "v1"
//                registry.missCount shouldBe 1L
//                registry.putCount shouldBe 1L
//                registry.hitCount shouldBe 0L
...
//
//                result.shouldBeInstanceOf<RegistryGetOrPutResult.Failed>()
//                registry.failureCount shouldBe 1L
//                registry.putCount shouldBe 0L
//            }
//        }
...
//
//                result.shouldBeInstanceOf<RegistryEvictResult.Evicted>()
...
//
//                result.shouldBeInstanceOf<RegistryEvictResult.NotFound>()
//                registry.evictionCount shouldBe 0L
//            }
//        }
//
