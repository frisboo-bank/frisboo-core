...
internal fun VersionCatalog.requiredVersion(alias: String): String = findVersion(alias).orElseThrow {
...
internal fun VersionCatalog.libraryOrThrow(alias: String) = findLibrary(alias).orElseThrow {
